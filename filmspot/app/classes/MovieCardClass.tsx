    ...
    render(){
        ...
        return (
            <div className="movieCard relative snap-center">
                ...
                <Link to={`/content/${this.props.media_type}.${this.props.id}`} className="absolute top-0 left-0 w-full h-full" />
