function Footer(){
    return (
        <footer className="pt-6 bg-[var(--backgroundTransparentSecondary)] z-100 relative border-t border-[var(--borderColorSecondary)]">
            ...
            <p className="w-full p-3 text-center text-white font-light bg-[#11151C]">Copyright © 2025 | <span className="text-[var(--textAccentColor)]">Film</span>Spot | All Rights Reserved</p>
        </footer>
    );
}
