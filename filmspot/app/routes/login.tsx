...
export default function FilmSpotLogin() {
  ...
  return (
    <div className="min-h-screen flex items-start lg:items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl flex flex-col-reverse lg:grid lg:grid-cols-2 gap-5 lg:gap-15 items-center z-40 p-5">
        ...
        <div className="w-full bg-[var(--backgroundTransparentSecondary)] backdrop-blur-sm border border-[var(--borderColorSecondary)] rounded-2xl p-10 pb-20 shadow-2xl shrink-0">
          <div className="mb-8">
        ...
        <div className="text-center lg:text-left mb-5">
          <div className="flex items-center justify-center lg:justify-start mb-6 gap-3">
            ...
            <h2 className="text-4xl font-bold text-white">FilmSpot</h2>
          </div>
