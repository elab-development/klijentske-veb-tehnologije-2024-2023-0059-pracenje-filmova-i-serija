...
export default function Header(){
    ...
    return (
        <header className="fixed top-0 left-0 w-full h-fit py-2 px-5 border-b-1 border-[var(--borderColorPrimary)] flex items-center justify-between bg-[var(--backgroundTransparentPrimary)] backdrop-blur-[10px]">
